...
return {
	...
	init() {
		...
		setTimeout(function updateImg() {

			const stars_out = this['MainContainer'].els['banner-star-out'];
			const stars_in = this['MainContainer'].els['banner-star-in'];

			if (stars_out.length + stars_in.length !== 10) return setTimeout(updateImg.bind(this), 100);
